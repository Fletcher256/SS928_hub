 ...
 * @brief      BMI270 configuration file (8KB sensor firmware blob)
 * @note       Extracted from Bosch bmi270.c v2.86.1
 *             DO NOT EDIT — this is proprietary binary firmware data.
 */
